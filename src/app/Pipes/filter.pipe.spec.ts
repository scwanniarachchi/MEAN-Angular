...
describe('FilterPipe', () => {
  ...
  it('Transform Returns Array Without a Object 01', () => {
    result = pipe.transform([], "1234");

    expect(result).toEqual([]);
  });

  it('Transform Returns Array with a Object 02', () => {
  ...
  it('Transform Returns Array with Objects 04', () => {
    result = pipe.transform([{name: '1234'}, {name: '1246567'}, {name: '14'}, {name: '2222'}], "4");

    expect(result).toEqual([{name: '1234'}, {name: '1246567'}, {name: '14'}]);
  });

  it('Transform Returns Empty Array without any Object 05', () => {
